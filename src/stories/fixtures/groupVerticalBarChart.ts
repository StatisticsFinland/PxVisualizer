...
export const GROUP_VERTICAL_BAR_CHART: { pxGraphData: IQueryVisualizationResponse, selectedVariableCodes: TVariableSelections | undefined, showLastUpdated: boolean } = {
    pxGraphData: {
...
export const GROUP_VERTICAL_BAR_CHART_WITH_SELECTABLES: { pxGraphData: IQueryVisualizationResponse, selectedVariableCodes: { [key: string]: string[] } | undefined } = {
    pxGraphData: {
        tableReference: { name: "table.px", hierarchy: ["foo", "bar"] },
        data: [
            11096.0,
...
export const GROUP_VERTICAL_BAR_CHART_WITH_SELECTABLES_PIVOTED: { pxGraphData: IQueryVisualizationResponse, selectedVariableCodes: { [key: string]: string[] } | undefined } = {
    pxGraphData: {
        tableReference: { name: "table.px", hierarchy: ["foo", "bar"] },
        "data": [
            11096.0,

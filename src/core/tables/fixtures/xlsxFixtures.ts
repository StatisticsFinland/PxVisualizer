export const XLSX_FIXTURES_COMPLEX_VIEW_ROW_AND_COL_VARS: { [key: string]: (string | null)[][] } = {
    'fi':
        [
...
export const XLSX_FIXTURES_COL_VARS: { [key: string]: (string | null)[][] } = {
    'fi':
        [
...
export const XLSX_FIXTURES_ROW_VARS: { [key: string]: (string | null)[][] } = {
    'fi':
        [
...
export const XLSX_FIXTURES_ROW_AND_COL_VARS: { [key: string]: (string | null)[][] } = {
    'fi':
        [
...
export const XLSX_FIXTURES_ONE_CELL: { [key: string]: (string | null)[][] } = {
    'fi':
        [

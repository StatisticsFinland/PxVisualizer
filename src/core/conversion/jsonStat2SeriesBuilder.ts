import { IJsonStat2Dataset, IQueryVisualizationResponse } from "../types";
...
export class JsonStat2SeriesBuilder {
    public dataIndex: number;
    public dataLength: number;

    private readonly responseObj: IJsonStat2Dataset;
    ...
    constructor(responseObj: IJsonStat2Dataset, selectedValueCodes: TVariableSelections) {
